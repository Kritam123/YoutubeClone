  ...
  return (
    ...
    >
      ...
      <Input
        ...
        className=" placeholder:text-md text-md placeholder:text-sm placeholder:font-semibold group pr-12 bg-transparent border-t-0 border-b-0 border-l-0   rounded-full rounded-r-none focus-visible:ring-1 focus-visible:ring-blue-500 focus-visible:ring-offset-0"
      />
      {value && (
        <Button
          variant={"secondary"}
